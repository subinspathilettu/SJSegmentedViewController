...
spec.homepage               = 'https://code.qburst.com/subinsjose/SJSegmentedScrollView'
spec.author                 = { 'Subins Jose' => 'subinsjose@gmail.com' }
spec.summary                = 'Custom segmented header scrollview controller.'
spec.source                 = { :git => 'https://code.qburst.com/subinsjose/SJSegmentedScrollView.git', :tag => '1.0.6' }
