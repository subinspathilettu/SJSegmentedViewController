...
[![CI Status](http://img.shields.io/travis/SubinsJose/SJSegmentedScrollView.svg?style=flat)](https://travis-ci.org/subinspathilettu/SJSegmentedViewController)
...
pod ’SJSegmentedScrollView’, ‘1.0.10'
end
```
